...
Flow:
  Client → POST /receipts/upload-url { filename, store_id }
  ← { receipt_id, upload_url, s3_key, expires_in }
  Client → PUT photo directly to S3 using upload_url
  S3 automatically triggers processor Lambda
"""
...
def lambda_handler(event, context):
    ...
    # Create pending receipt record in DynamoDB
